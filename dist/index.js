...
function (_React$Component2) {
  ...
  _createClass(StatusUpdateFormInner, [{
    ...
    value: function render() {
      ...
      }, React.createElement(React.Fragment, null, this.props.displayAvatar ? userData.profileImage && React.createElement("div", {
        style: {
          marginRight: '16px'
        }
...
function (_React$Component) {
  ...
  _createClass(ActivityFooter, [{
    ...
    value: function render() {
      ...
      }), React.createElement(RepostButton, this.props))));
    }
  }]);
